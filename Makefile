...
# -----------------------------------------------------------
spark.root=/home/disha/Documents/CS6240/spark-2.3.1-bin-without-hadoop
...
aws.bucket.name=mr-hw1-bucket3
aws.input=input
aws.output=output
aws.log.dir=log
aws.num.nodes=1
...
local: jar clean-local-output
	/home/disha/Documents/CS6240/spark-2.3.1-bin-without-hadoop/bin/spark-submit --class ${job.name} --master ${local.master} --name "${app.name}" ${jar.name} ${local.input} ${local.output}
...
pseudo: jar stop-yarn format-hdfs init-hdfs upload-input-hdfs start-yarn clean-local-output 
	/home/disha/Documents/CS6240/spark-2.3.1-bin-without-hadoop/bin/spark-submit --class ${job.name} --master yarn --deploy-mode cluster ${jar.name} ${local.input} ${local.output}
